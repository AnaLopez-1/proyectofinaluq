...
public class Bus extends Vehiculo{
    ...
    public Bus (String marca, boolean esNuevo, int modelo, String cambios, int velocidadMaxima, String cilindraje, String combustible, String transmision, boolean revisionTecnica, int numeroPasajeros, int numeroPuertas, String capacidadMaletero, int numeroBolsasDeAire){
